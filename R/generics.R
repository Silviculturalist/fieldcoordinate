...
rotate_match_diameter <- function(id1,x1,y1,d1,species1,id2,x2,y2,d2,species2,diameter_tolerance=3){
  ...
  minimum_angle <- optimise(rotation_to_distance,interval=c(0,360),x.1=neighbouring$x,x.2=neighbouring$x2,y.1=neighbouring$y,y.2=neighbouring$y2)[[1]]

  #Value of mean distance between matches for minimum angle.
  mean_distance <- rotation_to_distance(rotation=minimum_angle,x.1 = neighbouring$x,y.1 = neighbouring$y,x.2=neighbouring$x2,y.2=neighbouring$y2)
